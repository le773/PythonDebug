...
### 01 偏差（Bias）与方差（Variance）
泛化误差可以分解为偏差、方差和噪声之和。偏差度量了学习算法的期望预测与真实结果的偏离程度，即刻画了学习算法本身的拟合能力；</br>
...
#### 01.08 置信度
![confidence_interval_1.jpg](https://i.imgur.com/RIpsiOq.jpg)

置信度的意义：

样本数目不变的情况下，做一百次试验，有95个置信区间包含了总体真值。置信度为95%其中大虚线表示总体参数真值θ，是所不知道的想要估计的值。

正因为在100个置信区间里有95个置信区间包括了真实值，所以当只做了一次置信区间时，也认为这个区间是可信的，是包含了总体参数真实值的。

置信度：如果不厌其烦地抽样本算区间，得到很多置信区间。那么在这些置信区间中，有95%的置信区间能覆盖到θ。
...
### 02.04 指数函数
![exp_1.png](https://i.imgur.com/yU1n111.png)

1. 指数函数的底数与图像间的关系可概括的记忆为：在y轴右边“底大图高”；在y轴左边“底大图低”

2. y = a<sup>x</sup> 与 y = (1/a)<sup>x</sup> 关于y轴对称

### 02.04.01 指数运算法则
![exp_2.png](https://i.imgur.com/KXiUtnD.png)
...
[似然与极大似然估计](https://zhuanlan.zhihu.com/p/22092462 "似然与极大似然估计")

[如何理解置信度？](https://www.zhihu.com/question/20183513)
